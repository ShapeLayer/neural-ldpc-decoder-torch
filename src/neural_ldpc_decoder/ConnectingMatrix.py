...
class ConnectingMatrix:
    def __init__(
        ...
        self.lifting_matrix_1 = np.zeros((self.neurons_per_odd_layer * self.Z, self.neurons_per_odd_layer * self.Z),
                                   self.dtype_lifting_matrix)
        self.lifting_matrix_2 = np.zeros((self.neurons_per_odd_layer * self.Z, self.neurons_per_odd_layer * self.Z),
                                   self.dtype_lifting_matrix)
